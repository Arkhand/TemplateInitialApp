...
sap.ui.define([
	...
	var P13nPopupMode = {Dialog: "Dialog",
		...
		var oContainer = new Dialog(this.getId() + "-dialog", {
			...
			buttons: [
				new Button(this.getId() + "-confirmBtn", {
					text:  mDialogSettings.confirm && mDialogSettings.confirm.text ?  mDialogSettings.confirm.text : oResourceBundle.getText("P13NDIALOG_OK"),
					type: "Emphasized",
					press: function() {
					...
					text: oResourceBundle.getText("P13NDIALOG_CANCEL"),
					press: function () {
	...
	Popup.prototype._createTitle = function() {
		...
		if (fnReset instanceof Function) {
			...
			oBar.addContentRight(new Button(this.getId() + "-resetBtn", {
				text: sap.ui.getCore().getLibraryResourceBundle("sap.m").getText("P13NDIALOG_RESET"),
				press: function(oEvt) {
